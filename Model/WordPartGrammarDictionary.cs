...
namespace Model
{
    ...
    {
        public static string Arabic(string grammar)
        {
            if (grammar != null)
            {
                if (s_arabic_dictionary.ContainsKey(grammar))
                {
                    return s_arabic_dictionary[grammar];
                }
            }
            return null;
        }
        public static string English(string grammar)
        {
            if (grammar != null)
            {
                if (s_english_dictionary.ContainsKey(grammar))
                {
                    return s_english_dictionary[grammar];
                }
            }
            return null;
        }
